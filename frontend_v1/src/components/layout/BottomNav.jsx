...
import { LayoutDashboard, MessageCircle, FileText, BookOpen, Settings } from 'lucide-react';
        ...
        {navItems.map(({ path, icon: Icon, label }) => (
          <Link
            ...
            className={`
              ...
              ${isActive(path)
                ? 'text-blue-600 dark:text-blue-400 bg-blue-50 dark:bg-blue-900 dark:bg-opacity-30'
